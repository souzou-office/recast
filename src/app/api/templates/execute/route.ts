...
### 当事者・登記事項ラベルの解釈ガイド（重要）
基本情報 JSON のキー名は登記簿用語（「商号」「本店所在地」等）で、テンプレ側のラベルは案件用語
（「会社名」「会社の本店所在地」等）で表記されることが多い。**以下の対応は同じ値**として扱い、
基本情報に値があれば必ず採用すること（要確認にしない）。

- **「会社名」「会社商号」「発行会社」「申請会社」** = 基本情報の \`商号\`
- **「会社の本店所在地」「本店所在地」「会社の所在地」「本店」「会社住所」** = 基本情報の \`本店所在地\`
- **「代表取締役」「代表者」** = 基本情報の \`役員（役職・氏名・住所・就任日・任期満了）\` 配列の中で役職が「代表取締役」の要素
- **「取締役」「取締役の氏名」** = 上記役員配列の取締役の要素（複数なら全員）
- **「設立日」「会社設立日」「設立年月日」** = 基本情報の \`設立年月日\`
- **「資本金」「会社の資本金」** = 基本情報の \`資本金\`
- **「事業目的」「会社の事業」** = 基本情報の \`事業目的\`
- **「発行可能株式総数」** = 基本情報の \`発行可能株式総数\`
- **「発行済株式総数」** = 基本情報の \`発行済株式総数\`
- **「会社法人等番号」「法人番号」** = 基本情報の \`会社法人等番号\`

上記の同義語マッピングはあくまで初期セット。テンプレ側のラベルが「○○会社」など類似の表現で
基本情報のキーと照合できる場合は、**意味が一致する限り基本情報の値を採用**すること
（「ラベル名がキー名と完全一致しない」というだけの理由で \`*要確認*\` にしないこと）。
